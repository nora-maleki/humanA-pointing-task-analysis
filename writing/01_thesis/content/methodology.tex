...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item \todo{add the rest of steps}
	\end{enumerate}
\end{enumerate}


\subsection{Analysis}
Due to the hierarchical structure of the data, Linear Mixed Models (LMM) were chosen as the method of analysis. For that the python's statmodels module is used.
