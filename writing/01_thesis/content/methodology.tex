...
A total number of \todo{28} participants, \todo{\# females and rest} with the average age of \todo{average age} with the standard deviation of \todo{sd age} took part in the experiment. The participants were all students of the University of Osnabrück. Before the start of the first exploration session all participant gave their written consent for taking part in the experiment \todo{see Apx. ?, consent form}. The participation was voluntary and only students with no health issue were selected \todo{see Apx. ?, the anamnesis form}. The participants were compensated by test-subject hours and/or 5€ per hour.  
