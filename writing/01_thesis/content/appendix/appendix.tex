...
\todo{
	add the table of starting locations with their id and names, human agent id and meaningfulness
}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=160mm]{figures/angle_starting_locations_boxplot_23.png}
	\caption[Absolute angular deviation at each starting location]{Absolute angular deviation at each starting location}
	\label{fig:angle_loc_box}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=100mm]{figures/deviation_degrees_loc_nr_51_23.png}
	\caption[Absolute angular deviation of the fastest starting location]{Absolute angular deviation of the fastest starting location}
